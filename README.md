...
This is PyTorch code implementation for the machine learning algorithm in paper "Joint Transmit and Pinching Beamforming for Pinching Antenna Systems (PASS): Optimization-Based or Learning-Based?", 
